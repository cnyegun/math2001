...
example {z : ℝ} (h1 : z ^ 2 - 2 = 0) : z ^ 4 - z ^ 3 - z ^ 2 + 2 * z + 1 = 3 :=
  calc
    z ^ 4 - z ^ 3 - z ^ 2 + 2 * z + 1
      = (z ^ 2 - 2 + 2) * (z ^ 2 - 2 + 2) - (z ^ 2 - 2 + 2) * z - (z ^ 2 - 2 + 2) + 2 * z + 1 := by ring
    _ = (0 + 2) * (0 + 2) - (0 + 2) * z - (0 + 2) + 2 * z + 1 := by rw[h1]
...
example {t : ℚ} (ht : t ^ 2 - 4 = 0) :
  ...
  calc
    t ^ 4 + 3 * t ^ 3 - 3 * t ^ 2 - 2 * t - 2
      = (t ^ 2 - 4 + 4) * (t ^ 2 - 4 + 4) + 3 * t * (t ^ 2 - 4 + 4) - 3 * (t ^ 2 - 4 + 4) - 2 * t - 2 := by ring
